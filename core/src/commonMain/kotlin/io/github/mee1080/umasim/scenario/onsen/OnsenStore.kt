...
val gensenData = mapOf(
    ...
    "疾駆の湯" to Gensen(
        ...
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.SPEED to 15, StatusType.POWER to 20))
    ),
    "堅忍の湯" to Gensen(
        name = "堅忍の湯",
        turns = 3,
        ...
        immediateEffect = Status(hp = 5),
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.STAMINA to 20, StatusType.GUTS to 20))
    ),
    "明晰の湯" to Gensen(
        name = "明晰の湯",
        turns = 3,
        ...
        immediateEffect = Status(hp = 5),
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.WISDOM to 20), statBonusOnRaceWin = 30)
    ),
    "駿閃の古湯" to Gensen(
        name = "駿閃の古湯",
        turns = 24,
    ...
    "剛脚の古湯" to Gensen(
        ...
        immediateEffect = Status(hp = 15),
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.POWER to 40, StatusType.GUTS to 40))
    ),
    "健壮の古湯" to Gensen(
        name = "健壮の古湯",
        turns = 24,
        ...
        immediateEffect = Status(hp = 15),
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.STAMINA to 40), staminaConsumptionDown = 10)
    ),
    "天翔の古湯" to Gensen(
        name = "天翔の古湯",
        turns = 24,
        ...
        immediateEffect = Status(hp = 15),
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.WISDOM to 40), statBonusOnRaceWin = 60)
    ),
    "秘湯ゆこま" to Gensen(
        name = "秘湯ゆこま",
        turns = 48,
        ...
        continuousEffect = GensenContinuousEffect(friendshipBonus = mapOf(StatusType.SPEED to 45, StatusType.STAMINA to 60, StatusType.POWER to 60, StatusType.GUTS to 60, StatusType.WISDOM to 60), extraSupportInTraining = true)
    ),
    "伝説の秘湯" to Gensen(
        name = "伝説の秘湯",
        turns = 65,
...
val excavationProgressBonus = mapOf(
