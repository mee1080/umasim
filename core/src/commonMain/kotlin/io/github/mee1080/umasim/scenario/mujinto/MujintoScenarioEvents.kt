...
import io.github.mee1080.umasim.simulation2.addRelation
...
//        }
    ...
    private fun handleTuckerBlighPostTraining(state: SimulationState): SimulationState {
        ...
        newState = newState.addRelation(5) { it.index == state.tuckerBlighIndex }
        ...
        newState = newState.updateMujintoStatus {
            copy(
                tuckerSpecialtyBuffNextTurn = true,
                tuckerSpecialtyBuffNextTurnAmount = 20
            )
        }

        // "大成功ならやる気+1" - How is "大成功" determined for a training event?
        // Assuming a 10% chance for placeholder.
        if (Random.nextInt(100) < 10) { // Placeholder for "大成功"
            newState = newState.addStatus(Status(motivation = 1))
        }
        return newState
    }

//    private suspend fun handleTuckerBlighOuting(
...
//        val tuckerOutingCount =
//            state.member[state.tuckerBlighIndex].outingCount // Assuming outingCount exists on member
//
...
//                    copy(
//                        tuckerSpecialtyBuffNextTurn = true,
//                        tuckerSpecialtyBuffNextTurnAmount = 30
//                    )
//                }
//
//            }
...
//                newState = newState.addRelation(5) { it.index == state.tuckerBlighIndex }
//                newState = newState.addStatus(
//                    Status(
//                        hp = 30,
//                        motivation = 1,
//                        power = 30,
//                        skillHint = mapOf("パスファインダー" to 3)
//                    )
//                )
...
//                    copy(
//                        tuckerSpecialtyBuffNextTurn = true,
//                        tuckerSpecialtyBuffNextTurnAmount = 120
//                    )
//                }
//            }
//        }
