...
//    TrainingBase(toScenario(3), toSupportType("P"), 5, 532, Status(0, 6, 10, 0, 0, 2, -24)),
    ...
    TrainingBase(toScenario(3), toSupportType("H"), 2, 511, Status(0, 9, 0, 6, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("H"), 3, 515, Status(0, 10, 0, 6, 0, 2, -22)),
    TrainingBase(toScenario(3), toSupportType("H"), 4, 519, Status(0, 11, 0, 7, 0, 2, -24)),
    TrainingBase(toScenario(3), toSupportType("H"), 5, 523, Status(0, 12, 0, 8, 0, 2, -26)),
