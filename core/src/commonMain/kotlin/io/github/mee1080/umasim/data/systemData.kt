...
internal val trainingData = listOf(
    ...
    // TODO グランドライブで合宿とLv5が異なる
    TrainingBase(toScenario(3), toSupportType("S"), 1, 520, Status(8, 0, 4, 0, 0, 2, -19)),
    TrainingBase(toScenario(3), toSupportType("S"), 2, 524, Status(9, 0, 4, 0, 0, 2, -20)),
    TrainingBase(toScenario(3), toSupportType("S"), 3, 528, Status(10, 0, 4, 0, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("S"), 4, 532, Status(11, 0, 5, 0, 0, 2, -23)),
    TrainingBase(toScenario(3), toSupportType("S"), 5, 536, Status(12, 0, 6, 0, 0, 2, -25)),
    TrainingBase(toScenario(3), toSupportType("P"), 1, 516, Status(0, 4, 9, 0, 0, 2, -20)),
    TrainingBase(toScenario(3), toSupportType("P"), 2, 520, Status(0, 4, 10, 0, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("P"), 3, 524, Status(0, 4, 11, 0, 0, 2, -22)),
    TrainingBase(toScenario(3), toSupportType("P"), 4, 528, Status(0, 5, 12, 0, 0, 2, -24)),
    TrainingBase(toScenario(3), toSupportType("P"), 5, 532, Status(0, 6, 13, 0, 0, 2, -26)),
//    TrainingBase(toScenario(3), toSupportType("P"), 5, 532, Status(0, 6, 10, 0, 0, 2, -24)),
    TrainingBase(toScenario(3), toSupportType("G"), 1, 532, Status(2, 0, 2, 7, 0, 2, -20)),
    TrainingBase(toScenario(3), toSupportType("G"), 2, 536, Status(2, 0, 2, 8, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("G"), 3, 540, Status(2, 0, 2, 9, 0, 2, -22)),
    TrainingBase(toScenario(3), toSupportType("G"), 4, 544, Status(3, 0, 2, 10, 0, 2, -24)),
    TrainingBase(toScenario(3), toSupportType("G"), 5, 548, Status(3, 0, 3, 11, 0, 2, -26)),
    TrainingBase(toScenario(3), toSupportType("H"), 1, 507, Status(0, 8, 0, 6, 0, 2, -20)),
    TrainingBase(toScenario(3), toSupportType("H"), 2, 511, Status(0, 9, 0, 6, 0, 2, -20)),
    TrainingBase(toScenario(3), toSupportType("H"), 3, 515, Status(0, 10, 0, 6, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("H"), 4, 519, Status(0, 11, 0, 7, 0, 2, -22)),
    TrainingBase(toScenario(3), toSupportType("H"), 5, 523, Status(0, 12, 0, 8, 0, 2, -23)),
//    TrainingBase(toScenario(3), toSupportType("H"), 5, 523, Status(0, 11, 0, 5, 0, 2, -23)),
    TrainingBase(toScenario(3), toSupportType("W"), 1, 320, Status(2, 0, 0, 0, 6, 3, 5)),
    TrainingBase(toScenario(3), toSupportType("W"), 2, 321, Status(2, 0, 0, 0, 7, 3, 5)),
    TrainingBase(toScenario(3), toSupportType("W"), 3, 322, Status(2, 0, 0, 0, 8, 3, 5)),
    TrainingBase(toScenario(3), toSupportType("W"), 4, 323, Status(3, 0, 0, 0, 9, 3, 5)),
    TrainingBase(toScenario(3), toSupportType("W"), 5, 324, Status(4, 0, 0, 0, 10, 3, 5)),
)
