...
internal val trainingData = listOf(
    ...
    TrainingBase(toScenario(7), toSupportType("S"), 11, 504, Status(12, 0, 1, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 12, 504, Status(13, 0, 1, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 13, 504, Status(14, 0, 1, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 14, 504, Status(15, 0, 1, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 15, 504, Status(16, 0, 2, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 11, 504, Status(0, 11, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 12, 504, Status(0, 12, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 13, 504, Status(0, 13, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 14, 504, Status(0, 14, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 15, 504, Status(0, 15, 0, 3, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 11, 504, Status(0, 2, 11, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 12, 504, Status(0, 2, 12, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 13, 504, Status(0, 2, 13, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 14, 504, Status(0, 2, 14, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 15, 504, Status(0, 3, 15, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 11, 504, Status(1, 0, 1, 12, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 12, 504, Status(1, 0, 1, 13, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 13, 504, Status(1, 0, 1, 14, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 14, 504, Status(1, 0, 1, 15, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 15, 504, Status(2, 0, 1, 16, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 11, 504, Status(2, 0, 0, 0, 11, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 12, 504, Status(2, 0, 0, 0, 12, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 13, 504, Status(2, 0, 0, 0, 13, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 14, 504, Status(3, 0, 0, 0, 14, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 15, 504, Status(3, 0, 0, 0, 15, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 21, 504, Status(8, 0, 1, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 22, 504, Status(9, 0, 1, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 23, 504, Status(10, 0, 1, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 24, 504, Status(11, 0, 1, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 25, 504, Status(12, 0, 2, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 21, 504, Status(0, 7, 0, 2, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 22, 504, Status(0, 8, 0, 2, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 23, 504, Status(0, 9, 0, 2, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 24, 504, Status(0, 10, 0, 2, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 25, 504, Status(0, 11, 0, 3, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 21, 504, Status(0, 2, 7, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 22, 504, Status(0, 2, 8, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 23, 504, Status(0, 2, 9, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 24, 504, Status(0, 2, 10, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 25, 504, Status(0, 3, 11, 0, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 21, 504, Status(1, 0, 1, 8, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 22, 504, Status(1, 0, 1, 9, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 23, 504, Status(1, 0, 1, 10, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 24, 504, Status(1, 0, 1, 11, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 25, 504, Status(2, 0, 1, 12, 0, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 21, 504, Status(2, 0, 0, 0, 7, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 22, 504, Status(2, 0, 0, 0, 8, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 23, 504, Status(2, 0, 0, 0, 9, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 24, 504, Status(2, 0, 0, 0, 10, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 25, 504, Status(3, 0, 0, 0, 11, 10, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 31, 504, Status(14, 0, 1, 0, 0, 4, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 32, 504, Status(15, 0, 1, 0, 0, 4, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 33, 504, Status(16, 0, 1, 0, 0, 4, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 34, 504, Status(17, 0, 1, 0, 0, 4, -15)),
    TrainingBase(toScenario(7), toSupportType("S"), 35, 504, Status(18, 0, 2, 0, 0, 4, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 31, 504, Status(1, 10, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 32, 504, Status(1, 11, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 33, 504, Status(1, 12, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 34, 504, Status(1, 13, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("H"), 35, 504, Status(2, 14, 0, 2, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 31, 504, Status(1, 2, 10, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 32, 504, Status(1, 2, 11, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 33, 504, Status(1, 2, 12, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 34, 504, Status(1, 2, 13, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("P"), 35, 504, Status(2, 2, 14, 0, 0, 6, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 31, 504, Status(2, 0, 1, 12, 0, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 32, 504, Status(2, 0, 1, 13, 0, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 33, 504, Status(2, 0, 1, 14, 0, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 34, 504, Status(2, 0, 1, 15, 0, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("G"), 35, 504, Status(3, 0, 1, 16, 0, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 31, 504, Status(4, 0, 0, 0, 10, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 32, 504, Status(4, 0, 0, 0, 11, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 33, 504, Status(4, 0, 0, 0, 12, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 34, 504, Status(4, 0, 0, 0, 13, 5, -15)),
    TrainingBase(toScenario(7), toSupportType("W"), 35, 504, Status(5, 0, 0, 0, 14, 5, -15)),

    // TODO COOK
    TrainingBase(toScenario(8), toSupportType("S"), 1, 520, Status(10, 0, 3, 0, 0, 6, -21)),
    TrainingBase(toScenario(8), toSupportType("S"), 2, 524, Status(11, 0, 3, 0, 0, 6, -22)),
    TrainingBase(toScenario(8), toSupportType("S"), 3, 528, Status(12, 0, 3, 0, 0, 6, -23)),
    TrainingBase(toScenario(8), toSupportType("S"), 4, 532, Status(13, 0, 4, 0, 0, 6, -25)),
    TrainingBase(toScenario(8), toSupportType("S"), 5, 536, Status(14, 0, 5, 0, 0, 6, -27)),
    TrainingBase(toScenario(8), toSupportType("S"), 6, 536, Status(16, 0, 5, 0, 0, 6, -21)),
    TrainingBase(toScenario(8), toSupportType("H"), 1, 507, Status(0, 9, 0, 4, 0, 6, -19)),
    TrainingBase(toScenario(8), toSupportType("H"), 2, 511, Status(0, 10, 0, 4, 0, 6, -20)),
    TrainingBase(toScenario(8), toSupportType("H"), 3, 515, Status(0, 11, 0, 4, 0, 6, -21)),
    TrainingBase(toScenario(8), toSupportType("H"), 4, 519, Status(0, 12, 0, 5, 0, 6, -23)),
    TrainingBase(toScenario(8), toSupportType("H"), 5, 523, Status(0, 13, 0, 6, 0, 6, -25)),
    TrainingBase(toScenario(8), toSupportType("H"), 6, 523, Status(0, 15, 0, 7, 0, 6, -19)),
    TrainingBase(toScenario(8), toSupportType("P"), 1, 516, Status(0, 5, 11, 0, 0, 6, -20)),
    TrainingBase(toScenario(8), toSupportType("P"), 2, 520, Status(0, 5, 12, 0, 0, 6, -21)),
    TrainingBase(toScenario(8), toSupportType("P"), 3, 524, Status(0, 5, 13, 0, 0, 6, -22)),
    TrainingBase(toScenario(8), toSupportType("P"), 4, 528, Status(0, 6, 14, 0, 0, 6, -24)),
    TrainingBase(toScenario(8), toSupportType("P"), 5, 532, Status(0, 7, 15, 0, 0, 6, -26)),
    TrainingBase(toScenario(8), toSupportType("P"), 6, 532, Status(0, 9, 17, 0, 0, 6, -20)),
    TrainingBase(toScenario(8), toSupportType("G"), 1, 532, Status(3, 0, 2, 10, 0, 6, -21)),
    TrainingBase(toScenario(8), toSupportType("G"), 2, 536, Status(3, 0, 2, 11, 0, 6, -22)),
    TrainingBase(toScenario(8), toSupportType("G"), 3, 540, Status(3, 0, 2, 12, 0, 6, -23)),
    TrainingBase(toScenario(8), toSupportType("G"), 4, 544, Status(4, 0, 2, 13, 0, 6, -25)),
    TrainingBase(toScenario(8), toSupportType("G"), 5, 548, Status(4, 0, 3, 14, 0, 6, -27)),
    TrainingBase(toScenario(8), toSupportType("G"), 6, 548, Status(6, 0, 5, 16, 0, 6, -21)),
    TrainingBase(toScenario(8), toSupportType("W"), 1, 320, Status(2, 0, 0, 0, 9, 6, 5)),
    TrainingBase(toScenario(8), toSupportType("W"), 2, 321, Status(2, 0, 0, 0, 10, 6, 5)),
    TrainingBase(toScenario(8), toSupportType("W"), 3, 322, Status(2, 0, 0, 0, 11, 6, 5)),
    TrainingBase(toScenario(8), toSupportType("W"), 4, 323, Status(3, 0, 0, 0, 12, 6, 5)),
    TrainingBase(toScenario(8), toSupportType("W"), 5, 324, Status(4, 0, 0, 0, 13, 6, 5)),
    TrainingBase(toScenario(8), toSupportType("W"), 6, 324, Status(5, 0, 0, 0, 14, 6, 6)),
)
