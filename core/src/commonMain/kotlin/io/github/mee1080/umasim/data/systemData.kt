...
internal val trainingData = listOf(
    ...
    TrainingBase(toScenario(6), toSupportType("S"), 2, 524, Status(11, 0, 3, 0, 0, 6, -20)),
    TrainingBase(toScenario(6), toSupportType("S"), 3, 528, Status(12, 0, 3, 0, 0, 6, -21)),
    TrainingBase(toScenario(6), toSupportType("S"), 4, 532, Status(13, 0, 4, 0, 0, 6, -23)),
    TrainingBase(toScenario(6), toSupportType("S"), 5, 536, Status(14, 0, 5, 0, 0, 6, -25)),
    ...
    TrainingBase(toScenario(6), toSupportType("H"), 2, 511, Status(0, 10, 0, 4, 0, 6, -21)),
    TrainingBase(toScenario(6), toSupportType("H"), 3, 515, Status(0, 11, 0, 4, 0, 6, -22)),
    TrainingBase(toScenario(6), toSupportType("H"), 4, 519, Status(0, 12, 0, 5, 0, 6, -24)),
    TrainingBase(toScenario(6), toSupportType("H"), 5, 523, Status(0, 13, 0, 6, 0, 6, -26)),
    ...
    TrainingBase(toScenario(6), toSupportType("G"), 2, 536, Status(3, 0, 2, 11, 0, 6, -21)),
    TrainingBase(toScenario(6), toSupportType("G"), 3, 540, Status(3, 0, 2, 12, 0, 6, -22)),
    TrainingBase(toScenario(6), toSupportType("G"), 4, 544, Status(4, 0, 2, 13, 0, 6, -24)),
    TrainingBase(toScenario(6), toSupportType("G"), 5, 548, Status(4, 0, 3, 14, 0, 6, -26)),
