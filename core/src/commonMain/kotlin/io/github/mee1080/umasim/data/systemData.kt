...
internal val trainingData = listOf(
    ...
    TrainingBase(toScenario(3), toSupportType("P"), 2, 520, Status(0, 4, 9, 0, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("P"), 3, 524, Status(0, 4, 9, 0, 0, 2, -22)),
    TrainingBase(toScenario(3), toSupportType("P"), 4, 528, Status(0, 5, 10, 0, 0, 2, -23)),
    ...
    TrainingBase(toScenario(3), toSupportType("H"), 2, 511, Status(0, 8, 0, 6, 0, 2, -20)),
    TrainingBase(toScenario(3), toSupportType("H"), 3, 515, Status(0, 9, 0, 6, 0, 2, -21)),
    TrainingBase(toScenario(3), toSupportType("H"), 4, 519, Status(0, 10, 0, 5, 0, 2, -22)),
