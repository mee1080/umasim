...
val mujintoTrainingData: List<TrainingBase> = listOf(
    ...
    TrainingBase(StatusType.STAMINA, 5, 523, Status(0, 13, 0, 7, 0, 5, -26)),
    ...
    TrainingBase(StatusType.GUTS, 5, 548, Status(3, 0, 3, 14, 0, 5, -26)),
...
val mujintoIslandTrainingBase = TrainingBase(StatusType.FRIEND, 0, 0, Status(6, 6, 4, 4, 10, 7, 0))
