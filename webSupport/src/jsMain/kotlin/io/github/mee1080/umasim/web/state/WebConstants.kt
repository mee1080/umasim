...
object WebConstants {
    ...
    val supportSortOrder = listOf(
        ...
        SortOrder("トレ効果（特殊固有なし）") { trainingFactor(type, 0, 0, 0, Status(maxHp = 100, hp = 100), 0) },
        SortOrder("トレ効果（特殊固有あり）") { trainingFactor(type, 100, 6, 1000000, Status(maxHp = 120, hp = 30), 600) },
