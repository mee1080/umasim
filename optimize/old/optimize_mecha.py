...
def objective(trial):
    ...
    evaluateSpeed   = '1.2 2200'
    evaluateStamina = '1.1 2000'
    evaluatePower   = '1.0 1700'
    evaluateGuts    = '0.9 1250'
    evaluateWisdom  = '1.0 1250'
    evaluateSkillPt = '1.3 6000'

    speed = [
        trial.suggest_int ('speed1', 60, 160, step=20),
        trial.suggest_int ('speed2', 60, 160, step=20),
        trial.suggest_int ('speed3', 60, 160, step=20),
        trial.suggest_int ('speed4', 60, 160, step=20),
        trial.suggest_int ('speed5', 60, 160, step=20),
    ]
    stamina = [
        trial.suggest_int ('stamina1', 60, 160, step=20),
        trial.suggest_int ('stamina2', 60, 160, step=20),
        trial.suggest_int ('stamina3', 60, 160, step=20),
        trial.suggest_int ('stamina4', 60, 160, step=20),
        trial.suggest_int ('stamina5', 60, 160, step=20),
    ]
    power = [
        trial.suggest_int ('power1', 60, 160, step=20),
        trial.suggest_int ('power2', 60, 160, step=20),
        trial.suggest_int ('power3', 60, 160, step=20),
        trial.suggest_int ('power4', 60, 160, step=20),
        trial.suggest_int ('power5', 60, 160, step=20),
    ]
    guts = [
        trial.suggest_int ('guts1', 60, 160, step=20),
        trial.suggest_int ('guts2', 60, 160, step=20),
        trial.suggest_int ('guts3', 60, 160, step=20),
        trial.suggest_int ('guts4', 60, 160, step=20),
        trial.suggest_int ('guts5', 60, 160, step=20),
    ]
    wisdom = [
        trial.suggest_int ('wisdom1', 60, 160, step=20),
        trial.suggest_int ('wisdom2', 60, 160, step=20),
        trial.suggest_int ('wisdom3', 60, 160, step=20),
        trial.suggest_int ('wisdom4', 60, 160, step=20),
        trial.suggest_int ('wisdom5', 60, 160, step=20),
    ]
    skillPt = [
        trial.suggest_int ('skillPt1', 60, 160, step=20),
        trial.suggest_int ('skillPt2', 60, 160, step=20),
        trial.suggest_int ('skillPt3', 60, 160, step=20),
        trial.suggest_int ('skillPt4', 60, 160, step=20),
        trial.suggest_int ('skillPt5', 60, 160, step=20),
    ]
    hp = [
        120,
        120,
    ...
    relation = trial.suggest_int ('relation', 1500, 3000, step=500)
    hpKeep = [
    ...
    overdriveThreshold = [
        trial.suggest_int ('overdriveThreshold1', 600, 1200, step=100),
        trial.suggest_int ('overdriveThreshold2', 1000, 2000, step=200),
        trial.suggest_int ('overdriveThreshold3', 3000, 5000, step=250),
        trial.suggest_int ('overdriveThreshold4', 5000, 9000, step=500),
        trial.suggest_int ('overdriveThreshold5', 8000, 14000, step=500),
    ]
    ...
    cmd = f'java -Dfile.encoding=UTF-8 -jar ../cli/build/libs/cli.jar --data-dir ../data'\
          ...
          f' --factor SPEED 3 --factor GUTS 3 --factor GUTS 3'\
